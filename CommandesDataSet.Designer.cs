...
namespace VentesApp_Projet {
    ...
    public partial class CommandesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Country, decimal TotalVentes) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public decimal TotalVentes {
                get {
                    try {
                        return ((decimal)(this[this.tableEmployees.TotalVentesColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'TotalVentes\' in table \'Employees\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployees.TotalVentesColumn] = value;
                }
            }
            ...
            public bool IsTotalVentesNull() {
                return this.IsNull(this.tableEmployees.TotalVentesColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTotalVentesNull() {
                this[this.tableEmployees.TotalVentesColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace VentesApp_Projet.CommandesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("TotalVentes", "TotalVentes");
            this._adapter.TableMappings.Add(tableMapping);
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT Employees.Country, SUM([Order Details].UnitPrice * [Order Details].Quantity) AS TotalVentes
...
GROUP BY Employees.Country";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Country", global::System.Data.SqlDbType.NVarChar, 15, global::System.Data.ParameterDirection.Input, 0, 0, "Country", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DateDebut", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "ShippedDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DateFin", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "ShippedDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(CommandesDataSet.EmployeesDataTable dataTable, string Country, global::System.Nullable<global::System.DateTime> DateDebut, global::System.Nullable<global::System.DateTime> DateFin) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Country == null)) {
        ...
        public virtual CommandesDataSet.EmployeesDataTable GetData(string Country, global::System.Nullable<global::System.DateTime> DateDebut, global::System.Nullable<global::System.DateTime> DateFin) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Country == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            CommandesDataSet.EmployeesDataTable dataTable = new CommandesDataSet.EmployeesDataTable();
